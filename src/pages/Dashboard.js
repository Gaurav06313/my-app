...
const handleConfirmSave = () => {
  ...
  // Add this line to show the table view
          ...
          {showTableView ? (
            <>
              <div className="d-flex justify-content-between align-items-center mb-4">
                <h2>Table View</h2>
                <div className="d-flex gap-2">
                  {/* Show Add Expense button only if there's data in any table */}
                  {Object.values(allUsers).some(table => table && table.length > 0) && (
                    <Button
                      variant="warning"
              ...
              {Object.entries(allUsers).map(([tableKey, rows]) =>
